...
```{r}
#read data file
sample_info = read.csv("sample_info_bed.csv")
apiary_info = read.csv("apiary_data.csv")
```
...
#read apiary data
p = ggplot(apiary_info[(apiary_info$region != "MA"),]) +
  #rnaturalearth map
  map_layer +
  #state borders
...
#make legend smaller, show map of us w/ inset 
  #print seperate map and use svg to put them together 

#ggsave() as final size (pdf, etc.) (min font size ~7)
plot(p)
```
